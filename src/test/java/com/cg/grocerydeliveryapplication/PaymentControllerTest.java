...
import com.cg.grocerydeliveryapplication.GroceryDeliveryApplication;
...
@ContextConfiguration(classes = GroceryDeliveryApplication.class)
public class PaymentControllerTest {
	...
	BDDMockito.given(paymentService.addPayment(Mockito.any())).willReturn(payment);
